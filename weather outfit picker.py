...
temperature = int(input("Enter today's teperature in Celcius: "))
...
its_raining = input("Is it raining today? (yes/no)")
...
# PART 7: Ask whther there are puddles on the ground
