...
gadget = input("Enter your favoutite gadget: ")
...
# PART 4: Typecast the numbers and true/false value into the text
...
print("Staus as text:", status_text, "-> type:", type(status_text))
...
# [start:stop:step] - step of -1 reverses the string
